import numpy as np
import difflib
from idm.inverse_dynamics.idm import *
...
def main():
    ...
    base_path = "/Users/davidepaglieri/Desktop/repos/fmrl/nld-nao"
    dbfilename = setup_dataset(base_path)
    gameid = 145461  # Winning game, quite short too! 30K steps
    gameid = 1846437  # Very short winning game. Good player (winning in 22K steps)
